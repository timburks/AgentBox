...
(request setHTTPBody:((dict username:"tim" password:"admin123") XMLPropertyListRepresentation))
...
(set request (NSMutableURLRequest requestWithURL:URL))
(set authValue (+ "Basic " (("tim:admin123" dataUsingEncoding:NSUTF8StringEncoding) base64EncodedString)))
